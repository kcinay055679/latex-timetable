...
\NewDocumentCommand{\createIsWorkdayCommand}{mm}
  { 
        ...
        % Debugging: Print the second element (should print "A" if it's there).
        % \seq_item:Nn \g_workday_seq { 2 } 
        % \str_if_eq:eeTF { \seq_item:Nn \g_workday_seq { 2 } } { A } { Ipa } { Ferie }
        % \str_if_eq:eeTF { \seq_item:Nn \g_workday_seq { 3 } } { A } { Ipa } { Ferie }
        
        % Define a command that takes an index and returns whether the value at that index is "A".
        % \NewDocumentCommand{\huii}{mm}{first: #1, second: #2}
        ...
        (value: \seq_item:Nn \l_workday_seq { ##1 })

        % Compare the extracted value with "A"
        \str_if_eq:eeTF { \seq_item:Nn {\l_workday_seq} { ##1 } } { A } { Ipa } { Ferie }
      }
      % \isWorkdayCommand{1}
  }
